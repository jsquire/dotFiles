...
Included in this section are the artifacts and references used for building and configuring a multi-purpose environment for an CachyOS or a compatible Arch-flavored distribution.  
...
* **surface-laptop**  
  _Authored in 2026, this directory contains scripts specific to configuring Microsoft Surface laptio hardware, including kernel installation and hardware service enablement._
...
* **init-shell.sh**  
  _Authored in 2026, this script installs ZSH and sets it as the default shell, then downloads the home directory configuration files from this repository.  It is intended to be run after bootstrapping to establish the shell environment and user preferences._

* **install-development.sh**  
  _Authored in 2026, this script automates installing and configuring of a set of development tools, focusing on Azure, .NET and, Nodejs. .  The actions performed by this script are intended to be general-purpose, but are targeted at a development workstation._