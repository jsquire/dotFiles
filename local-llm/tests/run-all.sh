...
fail=0
for s in test_schema.sh test_daemon.sh test_launchers_parity.sh test_installer_gen.sh test_imagegen_context.sh test_imagegen_path.sh test_office_skill.sh test_ollama_proxy.sh; do
    echo "########## $s ##########"
