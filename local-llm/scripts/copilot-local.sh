...
# Renders the TASK menu (menu.categories) when present; falls back to a flat list of modes otherwise.
_srv() {
...
while true; do
    ...
    case "$page" in
        ...
        server)
            ...
            box_top; box_center "Copilot Local"; box_line ""; box_center "squire-server : pick a task"; box_mid
            box_line ""
