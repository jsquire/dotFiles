...
if [[ "$MODE" == "full" ]]; then
    ...
    if command_exists systemctl; then
        for svc in vllm-switch-web.service vllm.service vllm@coder.service vllm@coder-alt.service vllm@image.service vllm@nemotron.service vllm@ornith.service vllm@kat-coder.service imagegen.service; do
